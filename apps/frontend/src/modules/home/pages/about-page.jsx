            ...
            <div className="max-w-3xl space-y-4 sm:ml-6 sm:space-y-5 lg:ml-10 lg:space-y-6">
              ...
              <div className="mt-4 flex items-start gap-3 rounded-lg border border-white/20 bg-gray-800/20 px-4 py-3 backdrop-blur-sm">
                ...
                <p className="font-display text-sm text-gray-100 sm:text-base">
                  For the best experience, please allow location access so Geo Memory Map can accurately place and
                  explore your memories on the map.
                </p>
              </div>
            </div>
          </MotionDiv>
          ...
          <div className="flex justify-center">
            ...
            >
              <MotionDiv variants={staggerContainer} initial="hidden" animate="visible">
                <MotionDiv className="flex items-start gap-4 sm:items-center sm:gap-6" variants={fadeUpItem}>
                  ...
                  <div>
                    <h3 className="text-white text-xl sm:text-2xl lg:text-3xl font-display font-semibold">
                      Pin Your Memories
                    </h3>
                    <p className="text-gray-100 text-base sm:text-lg lg:text-xl mt-2 font-display">
